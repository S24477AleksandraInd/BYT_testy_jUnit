...
public class Money implements Comparable {
    ...
    public String toString() {
        return String.format("%.02f %s", amount / 100.0, currency.getName());
    }
    ...
    public Money add(Money other) {
        var moneyConverted = this.currency.valueInThisCurrency(other.amount, other.currency);
        return new Money(this.amount + moneyConverted, this.currency);
    }
    ...
    public int compareTo(Object other) {
        // check if comparing to other Money object
